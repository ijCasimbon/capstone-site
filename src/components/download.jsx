      ...
      <div class="container">
        <div class="row align-items-center my-5">
          ...
          <div class="col-lg-5">
            ...
            <p><a href="https://github.com/ijCasimbon/capstone-site/raw/main/src/components/tired.jpg/" className="btn btn-dark btn-lg" role="button" aria-pressed="true" id="button" download>tired</a></p>
